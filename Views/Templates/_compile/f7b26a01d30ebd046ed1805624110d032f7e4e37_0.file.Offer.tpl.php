...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.48',
  'unifunc' => 'content_6ab3bcbab431a6_03355198',
...
function content_6ab3bcbab431a6_03355198 (Smarty_Internal_Template $_smarty_tpl) {
?><section class="bg-[#3a3a3a] text-white py-20" id="offer">
    <div class="max-w-[1480px] mx-auto px-12 grid md:grid-cols-2 gap-16 items-start">
        <div>
            <h2 class="text-[36px] font-400 text-white tracking-tight mb-[24px] uppercase"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['offer']->value['title'], ENT_QUOTES, 'UTF-8', true);?>
</h2>
            <p class="text-[18px] leading-[24px] font-bold mb-[24px]"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'nl2br' ][ 0 ], array( htmlspecialchars($_smarty_tpl->tpl_vars['offer']->value['lead_text'], ENT_QUOTES, 'UTF-8', true) ));?>
</p>
...
"
            ...
            <div class="hp-offer-quotes max-w-xl mx-auto" id="hp-offer-quotes" data-count="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'count' ][ 0 ], array( $_smarty_tpl->tpl_vars['offer_quotes']->value ));?>
">
                <div class="hp-offer-quote-stage relative overflow-hidden">
                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['offer_quotes']->value, 'q');
$_smarty_tpl->tpl_vars['q']->iteration = 0;
...
$__foreach_q_11_saved = $_smarty_tpl->tpl_vars['q'];
?>
...
”</span></blockquote>
                        <?php }?>
                        <?php if ($_smarty_tpl->tpl_vars['q']->value['quote_author']) {?>
                        <div class="text-center text-sm mt-4"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['q']->value['quote_author'], ENT_QUOTES, 'UTF-8', true);?>
</div>
                        <?php }?>
                    </div>
                    <?php
$_smarty_tpl->tpl_vars['q'] = $__foreach_q_11_saved;
}
...
$_smarty_tpl->tpl_vars['q']->index++;
$_smarty_tpl->tpl_vars['q']->first = !$_smarty_tpl->tpl_vars['q']->index;
$__foreach_q_12_saved = $_smarty_tpl->tpl_vars['q'];
?>
                    <button type="button"
                        ...
                        data-index="<?php echo $_smarty_tpl->tpl_vars['q']->index;?>
"
                        aria-label="<?php if ($_smarty_tpl->tpl_vars['q']->value['logo_alt']) {
echo htmlspecialchars($_smarty_tpl->tpl_vars['q']->value['logo_alt'], ENT_QUOTES, 'UTF-8', true);
} else { ?>Cytat <?php echo $_smarty_tpl->tpl_vars['q']->iteration;
}?>"
                        aria-selected="<?php if ($_smarty_tpl->tpl_vars['q']->first) {?>true<?php } else { ?>false<?php }?>">
                        <?php if ($_smarty_tpl->tpl_vars['q']->value['logo_url']) {?>
                        <img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['q']->value['logo_url'], ENT_QUOTES, 'UTF-8', true);?>
" alt="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['q']->value['logo_alt'], ENT_QUOTES, 'UTF-8', true);?>
"
                            class="w-12 h-10 object-contain bg-white p-1 block pointer-events-none">
                        <?php } else { ?>
                        <span class="inline-flex items-center justify-center w-12 h-10 bg-white/20 text-white text-[12px] font-bold"><?php echo $_smarty_tpl->tpl_vars['q']->iteration;?>
</span>
                        <?php }?>
                    </button>
                    <?php
$_smarty_tpl->tpl_vars['q'] = $__foreach_q_12_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                </div>
            ...
            <?php echo '<script'; ?>
 src="https://cdn.jsdelivr.net/npm/gsap@3.12.5/dist/gsap.min.js"><?php echo '</script'; ?>
>
            <?php echo '<script'; ?>
>
            (function () {
...
>
        ...
        <div class="flex flex-col items-center">
            <?php if ($_smarty_tpl->tpl_vars['offer']->value['image_url']) {?>
