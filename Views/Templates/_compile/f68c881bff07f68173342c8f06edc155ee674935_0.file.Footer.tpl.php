...
function content_6a8be8bf83f431_36285498 (Smarty_Internal_Template $_smarty_tpl) {
...
" value="1"
											checked><label for="<?php echo $_smarty_tpl->tpl_vars['csTag']->value['id'];?>
-1"><?php echo $_smarty_tpl->tpl_vars['csTag']->value['name'];?>
</label> <span class="count"
											id="<?php echo $_smarty_tpl->tpl_vars['csTag']->value['id'];?>
-1-count">(0)</span>
									</li>
								</ul>
							</li>
						...
						<li class="spaced">
							<div class="jui-select-box white cs-select" id="project-type-box">
								<select name="typ_projektu" id="project-type">
									...
									<option id="parterowe" value="parterowe"
										<?php if ($_smarty_tpl->tpl_vars['request']->value['typ_projektu'] == 'parterowe' || $_smarty_tpl->tpl_vars['csType']->value == 'parterowe') {?>
										selected<?php }?>>parterowe</option>
									<option id="z_poddaszem" value="z_poddaszem"
										<?php if ($_smarty_tpl->tpl_vars['request']->value['typ_projektu'] == 'z_poddaszem' || $_smarty_tpl->tpl_vars['csType']->value == 'z_poddaszem') {?>
										selected<?php }?>>z poddaszem
									</option>
									<option id="pietrowe" value="pietrowe"
										<?php if ($_smarty_tpl->tpl_vars['request']->value['typ_projektu'] == 'pietrowe' || $_smarty_tpl->tpl_vars['csType']->value == 'pietrowe') {?> selected<?php }?>>
										piętrowe</option>
									<option id="nothing" value="" disabled>--------</option>
									<option id="szkieletowe" value="szkieletowe"
										<?php if ($_smarty_tpl->tpl_vars['request']->value['typ_projektu'] == 'szkieletowe' || $_smarty_tpl->tpl_vars['csType']->value == 'szkieletowe') {?>
										selected<?php }?>>szkieletowe
									</option>
									<option id="blizniacze" value="blizniacze"
										<?php if ($_smarty_tpl->tpl_vars['request']->value['typ_projektu'] == 'blizniacze' || $_smarty_tpl->tpl_vars['csType']->value == 'blizniacze') {?>
										selected<?php }?>>bliźniacze
									</option>
									<option id="dwulokalowe" value="dwulokalowe"
										<?php if ($_smarty_tpl->tpl_vars['request']->value['typ_projektu'] == 'dwulokalowe' || $_smarty_tpl->tpl_vars['csType']->value == 'dwulokalowe') {?>
										selected<?php }?>>dwulokalowe
									</option>
							...
							<div class="jui-select-box right white cs-select" id="roof-type-box">
								<select name="typdachu" id="54">
									...
									<option id="54-dwuspadowy" value="dwuspadowy" <?php if ($_smarty_tpl->tpl_vars['request']->value['typdachu'] == 'dwuspadowy') {?>
										selected<?php }?>>
										dwuspadowy</option>
									<option id="54-mansardowy" value="mansardowy" <?php if ($_smarty_tpl->tpl_vars['request']->value['typdachu'] == 'mansardowy') {?>
										selected<?php }?>>
										mansardowy</option>
									<option id="54-stropodach" value="stropodach" <?php if ($_smarty_tpl->tpl_vars['request']->value['typdachu'] == 'stropodach') {?>
										selected<?php }?>>
										płaski</option>
									<option id="54-stozkowy" value="stozkowy" <?php if ($_smarty_tpl->tpl_vars['request']->value['typdachu'] == 'stozkowy') {?>
										selected<?php }?>>stożkowy
									</option>
									<option id="54-wielospadowy" value="wielospadowy"
										<?php if ($_smarty_tpl->tpl_vars['request']->value['typdachu'] == 'wielospadowy') {?> selected<?php }?>>wielospadowy</option>
								</select>
							</div>
						</li>
						...
						<li class="half-spaced">
							...
							<div>
								...
								<input type="radio" id="69-1" name="iloscpokoinaparterze" value="1"
									<?php if ($_smarty_tpl->tpl_vars['request']->value['iloscpokoinaparterze'] == 1) {?> checked<?php }?>><label for="69-1">1</label>
								<span class="count" id="69-1-count">(0)</span>
								<input type="radio" id="69-2" name="iloscpokoinaparterze" value="2"
									<?php if ($_smarty_tpl->tpl_vars['request']->value['iloscpokoinaparterze'] == 2) {?> checked<?php }?>><label for="69-2">2</label>
								<span class="count" id="69-2-count">(0)</span>
								<input type="radio" id="69-3" name="iloscpokoinaparterze" value="3"
									<?php if ($_smarty_tpl->tpl_vars['request']->value['iloscpokoinaparterze'] == 3) {?> checked<?php }?>><label for="69-3">3</label>
								<span class="count" id="69-3-count">(0)</span>
								<input type="radio" id="69-4" name="iloscpokoinaparterze" value="4"
									<?php if ($_smarty_tpl->tpl_vars['request']->value['iloscpokoinaparterze'] == 4) {?> checked<?php }?>><label for="69-4">4</label>
								<span class="count" id="69-4-count">(0)</span>
								<input type="radio" id="69-5" name="iloscpokoinaparterze" value="5"
									<?php if ($_smarty_tpl->tpl_vars['request']->value['iloscpokoinaparterze'] == 5) {?> checked<?php }?>><label for="69-5">5</label>
						...
						<li>
							...
							<div>
								...
								<input type="radio" name="liczbalazieneknaparterze" value="2" id="45-2"
									<?php if ($_smarty_tpl->tpl_vars['request']->value['liczbalazieneknaparterze'] == 2) {?> checked<?php }?>><label for="45-2">2</label>
								<span class="count" id="45-2-count">(0)</span>
								<input type="radio" name="liczbalazieneknaparterze" value="3" id="45-3"
									<?php if ($_smarty_tpl->tpl_vars['request']->value['liczbalazieneknaparterze'] == 3) {?> checked<?php }?>><label for="45-3">3</label>
							...
							<div>
								...
								<input type="radio" name="liczbalazieneknaiikondygnacji" value="2" id="46-2"
									<?php if ($_smarty_tpl->tpl_vars['request']->value['liczbalazieneknaiikondygnacji'] == 2) {?> checked<?php }?>><label
								...
								<input type="radio" name="liczbalazieneknaiikondygnacji" value="3" id="46-3"
									<?php if ($_smarty_tpl->tpl_vars['request']->value['liczbalazieneknaiikondygnacji'] == 3) {?> checked<?php }?>><label
					...
					<ul>
						<li class="half-spaced">
							<div class="jui-select-box white cs-select" id="height-box">
								<select name="wysokoscbudynku" id="26">
									...
									<option id="26-1" value="1" <?php if ($_smarty_tpl->tpl_vars['request']->value['wysokoscbudynku'] == 1) {?> selected<?php }?>>do 6 m
									</option>
									<option id="26-2" value="2" <?php if ($_smarty_tpl->tpl_vars['request']->value['wysokoscbudynku'] == 2) {?> selected<?php }?>>od 6 m
										do 7 m</option>
									<option id="26-3" value="3" <?php if ($_smarty_tpl->tpl_vars['request']->value['wysokoscbudynku'] == 3) {?> selected<?php }?>>od 7 m
										do 8 m</option>
									<option id="26-4" value="4" <?php if ($_smarty_tpl->tpl_vars['request']->value['wysokoscbudynku'] == 4) {?> selected<?php }?>>od 8 m
										do 9 m</option>
									<option id="26-5" value="5" <?php if ($_smarty_tpl->tpl_vars['request']->value['wysokoscbudynku'] == 5) {?> selected<?php }?>>od 9 m
										do 10 m</option>
									<option id="26-6" value="6" <?php if ($_smarty_tpl->tpl_vars['request']->value['wysokoscbudynku'] == 6) {?> selected<?php }?>>powyżej
										10 m</option>
								</select>
							</div>
							...
							<div class="jui-select-box right white cs-select" id="angle-box">
								<select name="katnachyleniadachu" id="27">
									...
									<option id="27-1" value="1" <?php if ($_smarty_tpl->tpl_vars['request']->value['katnachyleniadachu'] == 1) {?> selected<?php }?>>do
										30&deg;</option>
									<option id="27-2" value="2" <?php if ($_smarty_tpl->tpl_vars['request']->value['katnachyleniadachu'] == 2) {?> selected<?php }?>>
										30&deg; do 35&deg;
									</option>
									<option id="27-3" value="3" <?php if ($_smarty_tpl->tpl_vars['request']->value['katnachyleniadachu'] == 3) {?> selected<?php }?>>
										35&deg; do 40&deg;
									</option>
									<option id="27-4" value="4" <?php if ($_smarty_tpl->tpl_vars['request']->value['katnachyleniadachu'] == 4) {?> selected<?php }?>>
										40&deg; do 45&deg;
									</option>
									<option id="27-5" value="5" <?php if ($_smarty_tpl->tpl_vars['request']->value['katnachyleniadachu'] == 5) {?> selected<?php }?>>
										45&deg; i więcej
									</option>
								</select>
							</div>
						...
						<li class="spaced">
							<div class="jui-select-box white cs-select" id="ceiling-box">
								<select name="rodzajstropu" id="28">
									...
									<option id="28-lekki" value="lekki" <?php if ($_smarty_tpl->tpl_vars['request']->value['rodzajstropu'] == 'lekki') {?>
										selected<?php }?>>lekki</option>
									<option id="28-gestozebrowy" value="gestozebrowy"
										<?php if ($_smarty_tpl->tpl_vars['request']->value['rodzajstropu'] == 'gestozebrowy') {?> selected<?php }?>>gęstożebrowy</option>
									<option id="28-plyta_zelbetowa" value="plyta_zelbetowa"
										<?php if ($_smarty_tpl->tpl_vars['request']->value['rodzajstropu'] == 'plyta_zelbetowa') {?> selected<?php }?>>płyta żelbetowa
									</option>
									<option id="28-drewniany_belkowy" value="drewniany_belkowy"
										<?php if ($_smarty_tpl->tpl_vars['request']->value['rodzajstropu'] == 'drewniany_belkowy') {?> selected<?php }?>>drewniany
										belkowy</option>
								</select>
							</div>
							...
							<div class="jui-select-box right white cs-select" id="ridge-box">
								<select name="kalenica" id="103">
									...
									<option id="103-rownolegla_do_drogi" value="rownolegla_do_drogi"
										<?php if ($_smarty_tpl->tpl_vars['request']->value['kalenica'] == 'rownolegla_do_drogi') {?> selected<?php }?>>równoległa do
										drogi</option>
									<option id="103-prostopadla_do_drogi" value="prostopadla_do_drogi"
										<?php if ($_smarty_tpl->tpl_vars['request']->value['kalenica'] == 'prostopadla_do_drogi') {?> selected<?php }?>>prostopadła do
										drogi</option>
									<option id="103-brak" value="brak" <?php if ($_smarty_tpl->tpl_vars['request']->value['kalenica'] == 'brak') {?> selected<?php }?>>
										brak</option>
								</select>
							</div>
						</li>
								...
								<ul class="input-box">
									<li>
										<input type="checkbox" id="65-1" name="spizarnia" value="1"
											<?php if ($_smarty_tpl->tpl_vars['request']->value['spizarnia']) {?> checked<?php }?>><label for="65-1">Spiżarnia</label>
										<span class="count" id="65-1-count">(0)</span>
									</li>
									<li>
										<input type="checkbox" id="57-1" name="garderoba" value="1"
											<?php if ($_smarty_tpl->tpl_vars['request']->value['garderoba']) {?> checked<?php }?>><label for="57-1">Garderoba</label>
										<span class="count" id="57-1-count">(0)</span>
									</li>
									<li>
										<input type="checkbox" id="c18-1" name="duza_kotlownia" value="1"
											<?php if ($_smarty_tpl->tpl_vars['request']->value['duza_kotlownia']) {?> checked<?php }?>><label for="c18-1">Duża
								...
								<ul class="input-box">
									<li>
										<input type="checkbox" id="47-1" name="wiatagarazowa" value="1"
											<?php if ($_smarty_tpl->tpl_vars['request']->value['wiatagarazowa']) {?> checked<?php }?>><label for="47-1">Wiata</label>
										<span class="count" id="47-1-count">(0)</span>
									</li>
									<li>
										<input type="checkbox" id="96-1" name="pralnia" value="1" <?php if ($_smarty_tpl->tpl_vars['request']->value['pralnia']) {?>
											checked<?php }?>><label for="96-1">Pralnia</label> <span class="count"
											id="96-1-count">(0)</span>
									</li>
									<li>
										<input type="checkbox" id="c26-1" name="od_poludnia" value="1"
											<?php if ($_smarty_tpl->tpl_vars['request']->value['od_poludnia']) {?> checked<?php }?>><label for="c26-1">Wjazd od
						...
						<li>
							<div>
								<ul class="input-box">
									<li>
										<input type="checkbox" id="104-1" name="balkon" value="1" <?php if ($_smarty_tpl->tpl_vars['request']->value['balkon']) {?>
											checked<?php }?>><label for="104-1">Balkon</label> <span class="count"
											id="104-1-count">(0)</span>
									</li>
									<li>
										<input type="checkbox" id="105-1" name="lukarna" value="1" <?php if ($_smarty_tpl->tpl_vars['request']->value['lukarna']) {?>
											checked<?php }?>><label for="105-1">Lukarna</label> <span class="count"
											id="105-1-count">(0)</span>
									</li>
									<li>
										<input type="checkbox" id="113-1" name="masterbedroom" value="1"
											<?php if ($_smarty_tpl->tpl_vars['request']->value['masterbedroom']) {?> checked<?php }?>><label for="113-1">Master
						...
						<li>
							<div>
								<input type="checkbox" id="59-1" name="kuchniaodfrontu" value="1"
									<?php if ($_smarty_tpl->tpl_vars['request']->value['kuchniaodfrontu']) {?> checked<?php }?>><label for="59-1">Kuchnia od
									frontu</label> <span class="count" id="59-1-count">(0)</span>
								<div class="fright">
									<input type="checkbox" id="60-1" name="kuchniaodogrodu" value="1"
										<?php if ($_smarty_tpl->tpl_vars['request']->value['kuchniaodogrodu']) {?> checked<?php }?>><label for="60-1">Kuchnia od
						...
						<li>
							<div>
								<input type="checkbox" id="c19-1" name="kotlownia" value="1" <?php if ($_smarty_tpl->tpl_vars['request']->value['kotlownia']) {?>
									checked<?php }?>><label for="c19-1">Kotłownia na paliwo stałe</label> <span
									class="count" id="c19-1-count">(0)</span>
								<div class="fright">
									<input type="checkbox" id="67-1" name="zadaszonytaras" value="1"
										<?php if ($_smarty_tpl->tpl_vars['request']->value['zadaszonytaras']) {?> checked<?php }?>><label for="67-1">Zadaszony
						...
						<li class="half-spaced">
							<div>
								<input type="checkbox" id="94-1" name="antresola" value="1" <?php if ($_smarty_tpl->tpl_vars['request']->value['antresola']) {?>
									checked<?php }?>><label for="94-1">Otwarta przestrzeń</label> <span class="count"
									id="94-1-count">(0)</span>
								<div class="fright">
									<input type="checkbox" id="119-1" name="osobnewc" value="1" <?php if ($_smarty_tpl->tpl_vars['request']->value['osobnewc']) {?>
										checked<?php }?>><label for="119-1">Osobne w.c.</label> <span class="count"
						...
						<li>
							...
							<div>
								...
								<input type="radio" id="78-1" name="garaz" value="1" <?php if ($_smarty_tpl->tpl_vars['request']->value['garaz'] == 1) {?>
									checked<?php }?>><label for="78-1">1 stanowisko</label> <span class="count"
									id="78-1-count">(0)</span>
								<input type="radio" id="78-2" name="garaz" value="2" <?php if ($_smarty_tpl->tpl_vars['request']->value['garaz'] == 2) {?>
									checked<?php }?>><label for="78-2">2 i więcej</label> <span class="count"
									id="78-2-count">(0)</span>
								<input type="radio" id="78-3" name="garaz" value="3" <?php if ($_smarty_tpl->tpl_vars['request']->value['garaz'] == 3) {?>
									checked<?php }?>><label for="78-3">nie</label> <span class="count"
						...
						<li class="half-spaced">
							...
							<div>
								<input type="radio" id="2-0" name="piwnica" value="0"><label for="2-0"
									class="spaced">Dowolnie</label>
								<input type="radio" id="2-1" name="piwnica" value="1" <?php if ($_smarty_tpl->tpl_vars['request']->value['piwnica'] == 1) {?>
									checked<?php }?>><label for="2-1">tak</label> <span class="count"
									id="2-1-count">(0)</span>
								<input type="radio" id="2-2" name="piwnica" value="2" <?php if ($_smarty_tpl->tpl_vars['request']->value['piwnica'] == 2) {?>
									checked<?php }?>><label for="2-2">nie</label> <span class="count"
									id="2-2-count">(0)</span>
							</div>
						</li>
						<li>
