...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.48',
  'unifunc' => 'content_6a9f142b7019a1_01325841',
...
function content_6a9f142b7019a1_01325841 (Smarty_Internal_Template $_smarty_tpl) {
...
" <?php }?>
						class="block text-white text-[20px] font-normal hover:text-[var(--brand-blue)] transition"><?php echo $_smarty_tpl->tpl_vars['link']->value['label'];?>
</a>
				<?php
}
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
			...
			<div class="space-y-3">
				<div class="text-white text-[20px] font-semibold"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['contact']->value['header'])===null||$tmp==='' ? 'Kontakt' : $tmp);?>
</div>
...
"
						class="block text-white font-semibold text-[24px] pt-3 hover:text-[var(--brand-blue)]"><?php echo $_smarty_tpl->tpl_vars['contact']->value['email'];?>
</a>
				<?php }?>
...
"
						class="text-[var(--brand-blue)] text-[18px] underline"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['contact']->value['map_text'])===null||$tmp==='' ? 'zobacz dojazd' : $tmp);?>
</a>
				<?php }?>
			</div>
		</div>
