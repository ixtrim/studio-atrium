...
;transform:rotate(<?php if ((isset($_smarty_tpl->tpl_vars['photo']->value['rotate_deg']))) {
echo htmlspecialchars($_smarty_tpl->tpl_vars['photo']->value['rotate_deg'], ENT_QUOTES, 'UTF-8', true);
} else {
if ($_smarty_tpl->tpl_vars['photo']->index == 0) {?>-7<?php } elseif ($_smarty_tpl->tpl_vars['photo']->index == 1) {?>8<?php } else { ?>-4<?php }
}?>deg);width:186px;box-shadow:0 10px 28px -8px rgba(0,0,0,0.35), 0 2px 8px rgba(0,0,0,0.12)">
    ...
    <div class="bg-[#3a3a3a]">
        <div class="max-w-[1480px] mx-auto px-12 py-14 grid grid-cols-12 gap-[72px] items-center">
            <div class="col-span-12 md:col-span-5 text-white">
                ...
                <p class="text-[18px] leading-[24px] mt-[24px]"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['newsletter']->value['meta']['signup_body2'], ENT_QUOTES, 'UTF-8', true);?>
</p>
            </div>
                ...
                <form id="hp-newsletter-form" class="space-y-4" novalidate>
                    ...
                    <div class="flex justify-center mt-4">
                        <button type="submit" id="hp-newsletter-submit"
                            class="inline-flex items-center justify-center bg-[var(--brand-blue)] hover:bg-[var(--brand-blue-strong)] text-white font-bold px-16 py-4 lg:h-[54px] lg:max-h-[54px] lg:py-0 leading-none text-[13px] uppercase tracking-wider border-0 cursor-pointer disabled:opacity-60 disabled:cursor-wait"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['newsletter']->value['meta']['signup_button_label'], ENT_QUOTES, 'UTF-8', true);?>
</button>
                    </div>
                </form>
                <?php echo '<script'; ?>
...
>
            ...
            <div class="col-span-12 md:col-span-3 text-white">
                <div class="text-[28px] font-black uppercase leading-none"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['newsletter']->value['meta']['reward_line1'], ENT_QUOTES, 'UTF-8', true);?>
</div>
                ...
                <div class="text-[22px] font-bold leading-tight mt-3">
                    <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'nl2br' ][ 0 ], array( htmlspecialchars($_smarty_tpl->tpl_vars['newsletter']->value['meta']['reward_line2'], ENT_QUOTES, 'UTF-8', true) ));?>
</div>
            </div>
        </div>
    </div>
