...
function content_6a8c58a82b7952_53179829 (Smarty_Internal_Template $_smarty_tpl) {
...
" class="block relative h-[640px] bg-cover bg-center"
                        ...
                        <div class="max-w-[1480px] mx-auto px-8 h-full flex items-end pb-20">
                            <div class="bg-black/35 backdrop-blur-[2px] text-white px-12 py-10 max-w-[560px]">
                                <h1 class="text-[42px] md:text-[48px] font-black leading-[1.05] mb-3"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['slide']->value['title'], ENT_QUOTES, 'UTF-8', true);?>
</h1>
                                <?php if ($_smarty_tpl->tpl_vars['slide']->value['subtitle']) {?><div class="text-[26px] font-light leading-tight"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['slide']->value['subtitle'], ENT_QUOTES, 'UTF-8', true);?>
</div><?php }?>
                                <?php if ($_smarty_tpl->tpl_vars['slide']->value['badge']) {?><div class="text-[26px] font-black tracking-wide mb-4"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['slide']->value['badge'], ENT_QUOTES, 'UTF-8', true);?>
</div><?php }?>
                                <?php if ($_smarty_tpl->tpl_vars['slide']->value['body']) {?><p class="text-[16px] font-light leading-snug whitespace-pre-line opacity-95"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['slide']->value['body'], ENT_QUOTES, 'UTF-8', true);?>
</p><?php }?>
                            </div>
                        </div>
                    </a>
    ...
    <div class="max-w-[1480px] mx-auto px-8">
        <div class="text-center mb-4">
            <h2 class="text-white text-[20px] md:text-[22px] font-light tracking-wide">
                ...
                <?php if ($_smarty_tpl->tpl_vars['safety']->value['title_bold']) {?><span class="font-bold"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['safety']->value['title_bold'], ENT_QUOTES, 'UTF-8', true);?>
 </span><?php }?>
            ...
            <p class="text-white text-[11px] md:text-[12px] font-bold tracking-[0.12em] mt-1.5"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['safety']->value['subtitle'], ENT_QUOTES, 'UTF-8', true);?>
</p>
            <?php }?>
        </div>
...
?>
            <div class="flex items-center gap-3">
                <div class="text-white text-[36px] md:text-[44px] font-light leading-none"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['item_number'], ENT_QUOTES, 'UTF-8', true);?>
</div>
                <div class="text-white text-[13px] leading-snug whitespace-pre-line"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['item_text'], ENT_QUOTES, 'UTF-8', true);?>
</div>
            </div>
            <?php
}
