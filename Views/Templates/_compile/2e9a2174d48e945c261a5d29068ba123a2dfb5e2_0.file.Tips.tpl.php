...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.48',
  'unifunc' => 'content_6ab3bcbab32726_97181975',
...
function content_6ab3bcbab32726_97181975 (Smarty_Internal_Template $_smarty_tpl) {
?><section class="py-[75px] bg-white" id="tips">
    <div class="max-w-[1480px] mx-auto px-12">
        <h2 class="text-[36px] font-400 text-[var(--brand-darker)] tracking-tight mb-[36px] uppercase"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['porady']->value['section_title'], ENT_QUOTES, 'UTF-8', true);?>
</h2>
...
" class="group relative block w-[200px] h-[200px] overflow-hidden shrink-0 bg-[#f3f3f3]">
