		...
		<div id="person-box">
			<form id="contest-form" class="validable default" method="post" action="{url module=contest action=register}">
				<fieldset>
					...
					<div id="reg-box">
						<p id="accept-reg">
							<input type="checkbox" name="accept-reg" id="accept-r" value="on"> <label for="accept-r">Zapoznałem się i akceptuję</label> <a href="{$staticStockUrl}/docs/regulamin.pdf" target="_new" style="color: #c61000;">regulamin konkursu</a>
						</p>
