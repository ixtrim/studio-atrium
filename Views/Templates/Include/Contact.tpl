<section class="w-full my-10">
    <div class="grid grid-cols-1 md:grid-cols-12 overflow-hidden">
        ...
        <div class="md:col-span-4 bg-[#f3f3f3] px-10 py-10">
            ...
            <p class="text-[15px] leading-[1.9] text-[#333]">{$homepage_contact.question_body|escape}</p>
        </div>
        <div class="md:col-span-3 bg-[#f3f3f3] px-6 py-10">
            <form class="space-y-3"><input type="email" placeholder="{$homepage_contact.email_placeholder|escape}"
                    ...
                    class="w-full inline-flex items-center justify-center bg-[#e63329] hover:bg-[#cc2a21] text-white font-bold tracking-wider py-3 lg:h-[54px] lg:max-h-[54px] lg:py-0 leading-none text-[14px] uppercase transition-colors">{$homepage_contact.submit_label|escape}</button>
            </form>
        </div>
    </div>
</section>
