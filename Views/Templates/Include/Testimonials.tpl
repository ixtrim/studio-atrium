<section class="w-full max-w-[1200px] mx-auto px-4 my-12 text-center" id="testimonials">
    <p class="text-[#222] text-[18px] leading-[24px] font-bold"><span
            class="align-top mr-2">“</span>{$testimonials.meta.quote_text|escape|nl2br nofilter}<span
            class="align-top ml-2">“</span></p>
    <p class="mt-6 text-[18px] leading-[24px] text-[#7a7a7a]">{$testimonials.meta.attribution|escape}</p>
