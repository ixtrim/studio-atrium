	...
	<div class="cat-filter-groups">
		<div class="border-b border-black/10 bg-white cat-filter-group" data-open="1">
			...
			<div class="cat-filter-options px-4 pb-3 pt-1 space-y-1.5 bg-[#f5f5f5]">
				<label class="cat-filter-opt w-full flex items-center justify-start gap-2 text-left text-[12px] py-1.5 px-1 cursor-pointer"><input type="checkbox" class="js-cat-filter sr-only" name="typ_projektu" value="parterowe" data-group="typ_projektu"{if $af.typ_projektu == 'parterowe'} checked{/if}><span class="cat-check" aria-hidden="true"></span><span class="cat-filter-label">Parterowy</span></label>
				<label class="cat-filter-opt w-full flex items-center justify-start gap-2 text-left text-[12px] py-1.5 px-1 cursor-pointer"><input type="checkbox" class="js-cat-filter sr-only" name="typ_projektu" value="z_poddaszem" data-group="typ_projektu"{if $af.typ_projektu == 'z_poddaszem'} checked{/if}><span class="cat-check" aria-hidden="true"></span><span class="cat-filter-label">Z poddaszem</span></label>
				<label class="cat-filter-opt w-full flex items-center justify-start gap-2 text-left text-[12px] py-1.5 px-1 cursor-pointer"><input type="checkbox" class="js-cat-filter sr-only" name="typ_projektu" value="pietrowe" data-group="typ_projektu"{if $af.typ_projektu == 'pietrowe'} checked{/if}><span class="cat-check" aria-hidden="true"></span><span class="cat-filter-label">Piętrowy</span></label>
				<label class="cat-filter-opt w-full flex items-center justify-start gap-2 text-left text-[12px] py-1.5 px-1 cursor-pointer"><input type="checkbox" class="js-cat-filter sr-only" name="typ_projektu" value="z_garazem" data-group="typ_projektu"{if $af.typ_projektu == 'z_garazem'} checked{/if}><span class="cat-check" aria-hidden="true"></span><span class="cat-filter-label">Z garażem</span></label>
				<label class="cat-filter-opt w-full flex items-center justify-start gap-2 text-left text-[12px] py-1.5 px-1 cursor-pointer"><input type="checkbox" class="js-cat-filter sr-only" name="typ_projektu" value="szkieletowe" data-group="typ_projektu"{if $af.typ_projektu == 'szkieletowe'} checked{/if}><span class="cat-check" aria-hidden="true"></span><span class="cat-filter-label">Szkieletowy</span></label>
			</div>
		</div>
		<div class="border-b border-black/10 bg-white cat-filter-group" data-open="0">
			...
			<div class="cat-filter-options px-4 pb-3 pt-1 space-y-1.5 bg-[#f5f5f5] hidden">
				<label class="cat-filter-opt w-full flex items-center justify-start gap-2 text-left text-[12px] py-1.5 px-1 cursor-pointer"><input type="checkbox" class="js-cat-filter sr-only" name="typdachu" value="dwuspadowy" data-group="typdachu"{if $af.typdachu == 'dwuspadowy'} checked{/if}><span class="cat-check" aria-hidden="true"></span><span class="cat-filter-label">Dwuspadowy</span></label>
				<label class="cat-filter-opt w-full flex items-center justify-start gap-2 text-left text-[12px] py-1.5 px-1 cursor-pointer"><input type="checkbox" class="js-cat-filter sr-only" name="typdachu" value="wielospadowy" data-group="typdachu"{if $af.typdachu == 'wielospadowy'} checked{/if}><span class="cat-check" aria-hidden="true"></span><span class="cat-filter-label">Czterospadowy / wielospadowy</span></label>
				<label class="cat-filter-opt w-full flex items-center justify-start gap-2 text-left text-[12px] py-1.5 px-1 cursor-pointer"><input type="checkbox" class="js-cat-filter sr-only" name="typdachu" value="stropodach" data-group="typdachu"{if $af.typdachu == 'stropodach'} checked{/if}><span class="cat-check" aria-hidden="true"></span><span class="cat-filter-label">Płaski</span></label>
			</div>
		</div>
		<div class="border-b border-black/10 bg-white cat-filter-group" data-open="0">
			<button type="button" class="cat-filter-toggle w-full flex items-center justify-between px-4 py-3 text-[13px] hover:bg-[#f5f5f5] text-left transition-colors bg-transparent border-0 cursor-pointer text-[#222]"><span>Powierzchnia</span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="w-4 h-4 opacity-60 transition-transform cat-filter-chevron" aria-hidden="true"><path d="m6 9 6 6 6-6"></path></svg></button>
			<div class="cat-filter-options px-4 pb-3 pt-1 space-y-1.5 bg-[#f5f5f5] hidden">
				<label class="cat-filter-opt w-full flex items-center justify-start gap-2 text-left text-[12px] py-1.5 px-1 cursor-pointer"><input type="checkbox" class="js-cat-filter sr-only" name="pow_bucket" value="0-100" data-group="pow"{if $af.pow_bucket == '0-100'} checked{/if}><span class="cat-check" aria-hidden="true"></span><span class="cat-filter-label">do 100 m²</span></label>
				<label class="cat-filter-opt w-full flex items-center justify-start gap-2 text-left text-[12px] py-1.5 px-1 cursor-pointer"><input type="checkbox" class="js-cat-filter sr-only" name="pow_bucket" value="100-150" data-group="pow"{if $af.pow_bucket == '100-150'} checked{/if}><span class="cat-check" aria-hidden="true"></span><span class="cat-filter-label">100–150 m²</span></label>
				<label class="cat-filter-opt w-full flex items-center justify-start gap-2 text-left text-[12px] py-1.5 px-1 cursor-pointer"><input type="checkbox" class="js-cat-filter sr-only" name="pow_bucket" value="150-200" data-group="pow"{if $af.pow_bucket == '150-200'} checked{/if}><span class="cat-check" aria-hidden="true"></span><span class="cat-filter-label">150–200 m²</span></label>
				<label class="cat-filter-opt w-full flex items-center justify-start gap-2 text-left text-[12px] py-1.5 px-1 cursor-pointer"><input type="checkbox" class="js-cat-filter sr-only" name="pow_bucket" value="200-" data-group="pow"{if $af.pow_bucket == '200-'} checked{/if}><span class="cat-check" aria-hidden="true"></span><span class="cat-filter-label">powyżej 200 m²</span></label>
			</div>
		</div>
		<div class="border-b border-black/10 bg-white cat-filter-group" data-open="0">
			<button type="button" class="cat-filter-toggle w-full flex items-center justify-between px-4 py-3 text-[13px] hover:bg-[#f5f5f5] text-left transition-colors bg-transparent border-0 cursor-pointer text-[#222]"><span>Szerokość działki (maks.)</span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="w-4 h-4 opacity-60 transition-transform cat-filter-chevron" aria-hidden="true"><path d="m6 9 6 6 6-6"></path></svg></button>
			<div class="cat-filter-options px-4 pb-3 pt-1 space-y-1.5 bg-[#f5f5f5] hidden">
				<label class="cat-filter-opt w-full flex items-center justify-start gap-2 text-left text-[12px] py-1.5 px-1 cursor-pointer"><input type="checkbox" class="js-cat-filter sr-only" name="dzialka_szer" value="18" data-group="dzialka_szer"{if $af.dzialka_szer == '18' || $af.dzialka_szer == 18} checked{/if}><span class="cat-check" aria-hidden="true"></span><span class="cat-filter-label">wąska (do 18 m)</span></label>
				<label class="cat-filter-opt w-full flex items-center justify-start gap-2 text-left text-[12px] py-1.5 px-1 cursor-pointer"><input type="checkbox" class="js-cat-filter sr-only" name="dzialka_szer" value="25" data-group="dzialka_szer"{if $af.dzialka_szer == '25' || $af.dzialka_szer == 25} checked{/if}><span class="cat-check" aria-hidden="true"></span><span class="cat-filter-label">standardowa (do 25 m)</span></label>
			</div>
		</div>
		<div class="border-b border-black/10 bg-white cat-filter-group" data-open="0">
			<button type="button" class="cat-filter-toggle w-full flex items-center justify-between px-4 py-3 text-[13px] hover:bg-[#f5f5f5] text-left transition-colors bg-transparent border-0 cursor-pointer text-[#222]"><span>Maks. szerokość elewacji</span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="w-4 h-4 opacity-60 transition-transform cat-filter-chevron" aria-hidden="true"><path d="m6 9 6 6 6-6"></path></svg></button>
			<div class="cat-filter-options px-4 pb-3 pt-1 space-y-1.5 bg-[#f5f5f5] hidden">
				<label class="cat-filter-opt w-full flex items-center justify-start gap-2 text-left text-[12px] py-1.5 px-1 cursor-pointer"><input type="checkbox" class="js-cat-filter sr-only" name="front_szer" value="10" data-group="front_szer"{if $af.front_szer == '10' || $af.front_szer == 10} checked{/if}><span class="cat-check" aria-hidden="true"></span><span class="cat-filter-label">do 10 m</span></label>
				<label class="cat-filter-opt w-full flex items-center justify-start gap-2 text-left text-[12px] py-1.5 px-1 cursor-pointer"><input type="checkbox" class="js-cat-filter sr-only" name="front_szer" value="14" data-group="front_szer"{if $af.front_szer == '14' || $af.front_szer == 14} checked{/if}><span class="cat-check" aria-hidden="true"></span><span class="cat-filter-label">do 14 m</span></label>
			</div>
		</div>
		<div class="border-b border-black/10 bg-white cat-filter-group" data-open="0">
			<button type="button" class="cat-filter-toggle w-full flex items-center justify-between px-4 py-3 text-[13px] hover:bg-[#f5f5f5] text-left transition-colors bg-transparent border-0 cursor-pointer text-[#222]"><span>Pomieszczenia</span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="w-4 h-4 opacity-60 transition-transform cat-filter-chevron" aria-hidden="true"><path d="m6 9 6 6 6-6"></path></svg></button>
			<div class="cat-filter-options px-4 pb-3 pt-1 space-y-1.5 bg-[#f5f5f5] hidden">
				<label class="cat-filter-opt w-full flex items-center justify-start gap-2 text-left text-[12px] py-1.5 px-1 cursor-pointer"><input type="checkbox" class="js-cat-filter sr-only" name="iloscpokoinaparterze" value="2" data-group="iloscpokoinaparterze"{if $af.iloscpokoinaparterze == '2' || $af.iloscpokoinaparterze == 2} checked{/if}><span class="cat-check" aria-hidden="true"></span><span class="cat-filter-label">2 pokoje na parterze</span></label>
				<label class="cat-filter-opt w-full flex items-center justify-start gap-2 text-left text-[12px] py-1.5 px-1 cursor-pointer"><input type="checkbox" class="js-cat-filter sr-only" name="iloscpokoinaparterze" value="3" data-group="iloscpokoinaparterze"{if $af.iloscpokoinaparterze == '3' || $af.iloscpokoinaparterze == 3} checked{/if}><span class="cat-check" aria-hidden="true"></span><span class="cat-filter-label">3 pokoje na parterze</span></label>
				<label class="cat-filter-opt w-full flex items-center justify-start gap-2 text-left text-[12px] py-1.5 px-1 cursor-pointer"><input type="checkbox" class="js-cat-filter sr-only" name="iloscpokoinaparterze" value="4" data-group="iloscpokoinaparterze"{if $af.iloscpokoinaparterze == '4' || $af.iloscpokoinaparterze == 4} checked{/if}><span class="cat-check" aria-hidden="true"></span><span class="cat-filter-label">4 pokoje na parterze</span></label>
				<label class="cat-filter-opt w-full flex items-center justify-start gap-2 text-left text-[12px] py-1.5 px-1 cursor-pointer"><input type="checkbox" class="js-cat-filter sr-only" name="spizarnia" value="1"{if $af.spizarnia} checked{/if}><span class="cat-check" aria-hidden="true"></span><span class="cat-filter-label">Spiżarnia</span></label>
			</div>
		</div>
		<div class="border-b border-black/10 bg-white cat-filter-group" data-open="0">
			<button type="button" class="cat-filter-toggle w-full flex items-center justify-between px-4 py-3 text-[13px] hover:bg-[#f5f5f5] text-left transition-colors bg-transparent border-0 cursor-pointer text-[#222]"><span>Wysokość budynku</span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="w-4 h-4 opacity-60 transition-transform cat-filter-chevron" aria-hidden="true"><path d="m6 9 6 6 6-6"></path></svg></button>
			<div class="cat-filter-options px-4 pb-3 pt-1 space-y-1.5 bg-[#f5f5f5] hidden">
				<label class="cat-filter-opt w-full flex items-center justify-start gap-2 text-left text-[12px] py-1.5 px-1 cursor-pointer"><input type="checkbox" class="js-cat-filter sr-only" name="wysokoscbudynku" value="2" data-group="wysokoscbudynku"{if $af.wysokoscbudynku == '2' || $af.wysokoscbudynku == 2} checked{/if}><span class="cat-check" aria-hidden="true"></span><span class="cat-filter-label">do 7 m</span></label>
				<label class="cat-filter-opt w-full flex items-center justify-start gap-2 text-left text-[12px] py-1.5 px-1 cursor-pointer"><input type="checkbox" class="js-cat-filter sr-only" name="wysokoscbudynku" value="4" data-group="wysokoscbudynku"{if $af.wysokoscbudynku == '4' || $af.wysokoscbudynku == 4} checked{/if}><span class="cat-check" aria-hidden="true"></span><span class="cat-filter-label">7–9 m</span></label>
				<label class="cat-filter-opt w-full flex items-center justify-start gap-2 text-left text-[12px] py-1.5 px-1 cursor-pointer"><input type="checkbox" class="js-cat-filter sr-only" name="wysokoscbudynku" value="6" data-group="wysokoscbudynku"{if $af.wysokoscbudynku == '6' || $af.wysokoscbudynku == 6} checked{/if}><span class="cat-check" aria-hidden="true"></span><span class="cat-filter-label">powyżej 9 m</span></label>
			</div>
		</div>
		<div class="border-b border-black/10 bg-white cat-filter-group" data-open="0">
			<button type="button" class="cat-filter-toggle w-full flex items-center justify-between px-4 py-3 text-[13px] hover:bg-[#f5f5f5] text-left transition-colors bg-transparent border-0 cursor-pointer text-[#222]"><span>Kąt nachylenia dachu</span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="w-4 h-4 opacity-60 transition-transform cat-filter-chevron" aria-hidden="true"><path d="m6 9 6 6 6-6"></path></svg></button>
			<div class="cat-filter-options px-4 pb-3 pt-1 space-y-1.5 bg-[#f5f5f5] hidden">
				<label class="cat-filter-opt w-full flex items-center justify-start gap-2 text-left text-[12px] py-1.5 px-1 cursor-pointer"><input type="checkbox" class="js-cat-filter sr-only" name="katnachyleniadachu" value="1" data-group="katnachyleniadachu"{if $af.katnachyleniadachu == '1' || $af.katnachyleniadachu == 1} checked{/if}><span class="cat-check" aria-hidden="true"></span><span class="cat-filter-label">do 30°</span></label>
				<label class="cat-filter-opt w-full flex items-center justify-start gap-2 text-left text-[12px] py-1.5 px-1 cursor-pointer"><input type="checkbox" class="js-cat-filter sr-only" name="katnachyleniadachu" value="2" data-group="katnachyleniadachu"{if $af.katnachyleniadachu == '2' || $af.katnachyleniadachu == 2} checked{/if}><span class="cat-check" aria-hidden="true"></span><span class="cat-filter-label">30–35°</span></label>
				<label class="cat-filter-opt w-full flex items-center justify-start gap-2 text-left text-[12px] py-1.5 px-1 cursor-pointer"><input type="checkbox" class="js-cat-filter sr-only" name="katnachyleniadachu" value="3" data-group="katnachyleniadachu"{if $af.katnachyleniadachu == '3' || $af.katnachyleniadachu == 3} checked{/if}><span class="cat-check" aria-hidden="true"></span><span class="cat-filter-label">35–40°</span></label>
				<label class="cat-filter-opt w-full flex items-center justify-start gap-2 text-left text-[12px] py-1.5 px-1 cursor-pointer"><input type="checkbox" class="js-cat-filter sr-only" name="katnachyleniadachu" value="5" data-group="katnachyleniadachu"{if $af.katnachyleniadachu == '5' || $af.katnachyleniadachu == 5} checked{/if}><span class="cat-check" aria-hidden="true"></span><span class="cat-filter-label">powyżej 45°</span></label>
			</div>
		</div>
		<div class="border-b border-black/10 last:border-b-0 bg-white cat-filter-group" data-open="0">
			...
			<div class="cat-filter-options px-4 pb-3 pt-1 space-y-1.5 bg-[#f5f5f5] hidden">
				<label class="cat-filter-opt w-full flex items-center justify-start gap-2 text-left text-[12px] py-1.5 px-1 cursor-pointer"><input type="checkbox" class="js-cat-filter sr-only" name="rodzajstropu" value="drewniany_belkowy" data-group="rodzajstropu"{if $af.rodzajstropu == 'drewniany_belkowy'} checked{/if}><span class="cat-check" aria-hidden="true"></span><span class="cat-filter-label">Drewniany</span></label>
				<label class="cat-filter-opt w-full flex items-center justify-start gap-2 text-left text-[12px] py-1.5 px-1 cursor-pointer"><input type="checkbox" class="js-cat-filter sr-only" name="rodzajstropu" value="plyta_zelbetowa" data-group="rodzajstropu"{if $af.rodzajstropu == 'plyta_zelbetowa'} checked{/if}><span class="cat-check" aria-hidden="true"></span><span class="cat-filter-label">Żelbetowy</span></label>
				<label class="cat-filter-opt w-full flex items-center justify-start gap-2 text-left text-[12px] py-1.5 px-1 cursor-pointer"><input type="checkbox" class="js-cat-filter sr-only" name="rodzajstropu" value="gestozebrowy" data-group="rodzajstropu"{if $af.rodzajstropu == 'gestozebrowy'} checked{/if}><span class="cat-check" aria-hidden="true"></span><span class="cat-filter-label">Gęstożebrowy / Teriva</span></label>
			</div>
		</div>
	</div>
	<noscript>
