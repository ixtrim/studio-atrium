	...
	<ul class="item">
		<li>
			...
			<div>
				...
				{* if $sandbox == 1}
				<p style="margin-top: 16px; font-size: 1.4rem; color: #c61000;">Z uwagi na prace techniczne płatność online jest chwilowo niedostępna. W razie potrzeby prosimy o kontakt z konsultantem: tel. 33 822 94 96</p>
				{/if *}
			</div>
