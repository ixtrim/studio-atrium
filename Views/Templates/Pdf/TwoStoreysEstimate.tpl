...
<table class="list" cellpadding="3" cellspacing="0">
	<tbody>
		...
		<tr>
			...
			<td>3.50</td>
			<td>{number_format($cost * (3.5/100), 2, ',', ' ')}</td>
			<td>{number_format($costVat * (3.5/100), 2, ',', ' ')}</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
...
<table class="list" cellpadding="3" cellspacing="0">
	<tbody>
		...
		<tr class="summary">
			...
			<td>30.26</td>
			<td>{number_format($cost * (30.26/100), 2, ',', ' ')}</td>
			<td>{number_format($costVat * (30.26/100), 2, ',', ' ')}</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
...
<table class="list" cellpadding="3" cellspacing="0">
	<tbody>
		...
		<tr>
			...
			<td>4.45</td>
			<td>{number_format($cost * (4.45/100), 2, ',', ' ')}</td>
			<td>{number_format($costVat * (4.45/100), 2, ',', ' ')}</td>
			<td class="perc">&nbsp;</td>
			<td class="val">&nbsp;</td>
			<td class="perc">&nbsp;</td>
			<td class="val">&nbsp;</td>
