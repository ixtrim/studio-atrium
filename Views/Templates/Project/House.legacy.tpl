	...
	<div class="inline-wrapper">
			...
			{else}
				...
				{if $project.price}
					...
					{if $projectParams[97] && $projectParams[97].string_value != 'pompa ciepła'}
						...
						{else}
							<div id="pompInfo" style="display: none; text-align: center; color: #c61000;">UWAGA!<br>Przed złożeniem zamówienia zapytaj konsultanta o termin realizacji wariantu z pompą ciepła!</div>	
						{/if}
					{/if}
					{*if $project.discount && !$projectParams|isBlackWeek && !$projectParams|isChristmas}
						<p class="vatInfo" style="text-align: center; margin: 0 auto; font-size: 1.5rem;"><strong style="color: #c61000;">W ramach promocji istnieje możliwość dostosowania kotła na biomasę w cenie</strong> - termin realizacji do 14 dni roboczych.</p>
					{/if*}
				{else}
		...
		<div id="technical-data-box" class="technical-data">
			...
			{/foreach}
				...
				{/if}
				<tr{if $project.type == 'skeleton'} style="color: #c61000;"{/if}>
