...
// 		}
	...
	public function doStoreSummary(
		...
		if ($mailerConfig = $appContext->getConfigParam('mailer.sender')) {
			...
			$deliveryAndDiscount .= '<br><br><span style="color: #c61000;">Razem do zapłaty: <b>' . $formData['total'] . '</b> zł</span>';
			...
			$content .= '<br><p style="border-top: 1px solid #c61000; padding: 5px; padding-top: 10px; vertical-align: middle; line-height: 34px;">Dane do faktury:</p>';
